...
<div class="tile">
    <div class="tile-body">
        <form action="{{route('admin.pending-application.update',$model->uuid)}}" method="post" id="content_form">
            @method('patch')
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-4 form-group">
                    ...
                    <div class="">
                        <input type="number" min='0' readonly step="0.01" required name="interest_rate" id="interest_rate"
