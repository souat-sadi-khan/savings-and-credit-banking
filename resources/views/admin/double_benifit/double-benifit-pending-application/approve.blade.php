...
<div class="app-title text-center bg-danger text-white">
    <div class="text-center w-100">
        <h1 data-placement="bottom"
            title="Approve Double Benifit  Application Of  {{$account_information->member->name_in_bangla}}">{{--<i
                class="fa fa-users mr-4"></i>--}}
            {{_lang('Approved Double Benefit  Application Of ')}}{{$account_information->member->name_in_bangla}}</h1>
        <p>{{_lang('Here you can see approved double benefit application')}}</p>
    </div>
...
<div class="tile">
    <div class="tile-body">
        <div class="col-md-12 text-center">
            ...
            <div class="btn-group mt-1" role="group">
                ...
                <a data-placement="bottom" title="Edit Double Benifit"
                    href="{{ route('admin.pending-application.edit',$account_information->uuid) }}" id=""
                ...
                <a data-placement="bottom" title="Delete Double Benifit." href="" id="delete_item"
                    ...
                    data-url="{{route('admin.pending-application.destroy',$account_information->id) }}"
        ...
        <div class="col-md-12">
            <form action="{{route('admin.double-benifit-pending-application.add_approval',$account_information->uuid)}}"
