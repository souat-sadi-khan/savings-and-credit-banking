...
<div class="app-title text-center bg-danger text-white">
    <div class="text-center w-100">
        ...
        <p>{{_lang('Here you can see double benefit application information')}}</p>
    </div>
            ...
            <div class="btn-group mt-1" role="group">
                ...
                <a data-placement="bottom" title="Go Back To Previous Page"
                 ...
                 @can('double-benifit-pending-application.update')
                    ...
                    <a data-placement="bottom" title="Approve Account" href="{{ route('admin.double-benifit-pending-application.approval',$account_information->uuid) }}"
