<div class="btn-group mt-5" role="group">
    @can('approved_double_benifit.update')
    <a data-placement="bottom" title="Edit Double Benifit" href="{{ route('admin.approved-double-benifit.edit',$model->uuid) }}"
    ...
    @can('approved_double_benifit.delete')
...
<div class="btn-group mt-1" role="group">
    ...
    <a data-placement="bottom" title="View Details" href="{{ route('admin.approved-double-benifit.show',$model->uuid) }}"
        class="btn btn-primary text-light btn-sm" title="{{ _lang('show') }}" data-popup="tooltip"
        data-placement="bottom"><i class="fa fa-eye"></i></a>
    @endcan

    @can('approved_double_benifit.update_approval')
    <a data-placement="bottom" title="Update Approval" href="{{ route('admin.approved-double-benifit.approval',$model->uuid) }}"
