...
<div class="app-title text-center bg-danger text-white">
    <div class="text-center w-100">
        <h1 data-placement="bottom" title="Double Benifit Application Information Of  {{$account_information->member->name_in_bangla}}"><i
                class="fa fa-users mr-4"></i>
            {{_lang('Double Benifit Application Information Of ')}}{{$account_information->member->name_in_bangla}}</h1>
        ...
        <div class="col-md-12 text-center">
            ...
            <div class="btn-group mt-1" role="group">
                ...
                <a data-placement="bottom" title="Go Back To Previous Page"
                    href="{{ url()->previous() != url()->full() ? url()->previous() : route('admin.rejected-double-benifit.index') }}"
                    class="btn btn-secondary text-light btn-sm mr-2" title="{{ _lang('Back To Previous Page') }}" data-popup="tooltip"
                    data-placement="bottom">
                    <i class="fa fa-arrow-left"></i>Back
                </a>
 @can('rejected-double-benifit.update')
                    <a data-placement="bottom" title="Edit Double Benifit" href="{{ route('admin.rejected-double-benifit.edit',$account_information->uuid) }}"
                    ...
                    @can('rejected-double-benifit.delete')
                    ...
                    @can('rejected-double-benifit.approval')
                    <a data-placement="bottom" title="Approve Account" href="{{ route('admin.rejected-double-benifit.approval',$account_information->uuid) }}"
        ...
        <div class="row">
         ...
         <div class="row mt-1">
            ...
            <div class="col-md-4">
                ...
                @elseif($account_information->approval == 'Refused')
