...
<div class="app-title text-center bg-danger text-white">
    <div class="text-center w-100">
        <h1 data-placement="bottom" title="Edit Double Benifit Application Form ">{{--<i class="fa fa-users mr-4"></i>--}}
            {{_lang('Edit Double Benefit Application Form ')}}</h1>
        <p>{{_lang('Here You Can Submit Edited Double Benefit Application')}}</p>
    </div>
...
<div class="tile">
    <div class="tile-body">
        <form action="{{route('admin.rejected-double-benifit.update',$model->uuid)}}" method="post" id="content_form">
            @method('patch')
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-4 form-group">
                    ...
                    <div class="">
                        <input type="number" min='0' step="0.01" required name="interest_rate" id="interest_rate" readonly
