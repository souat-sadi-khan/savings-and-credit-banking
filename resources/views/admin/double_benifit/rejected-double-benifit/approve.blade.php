@extends('layouts.app', ['title' => _lang('Approve Double Benifit  Application'), 'modal' => 'lg'])

{{-- Header Section --}}
@section('page.header')
<div class="app-title text-center bg-danger text-white">
    <div class="text-center w-100">
        <h1 data-placement="bottom" title="Approve Double Benifit  Application Of  {{$account_information->member->name_in_bangla}}">{{--<i
                class="fa fa-users mr-4"></i>--}}
            {{_lang('Approve Double Benefit  Application Of ')}}{{$account_information->member->name_in_bangla}}</h1>
...
<div class="tile">
    <div class="tile-body">
        <div class="col-md-12 text-center">
            ...
            <div class="btn-group mt-1" role="group">
                ...
                <a data-placement="bottom" title="Go Back To Previous Page"
                 ...
                 @can('double-benifit-approved-double-benifit.update')
        ...
        <div class="col-md-12">
            <form action="{{route('admin.rejected-double-benifit.add_approval',$account_information->uuid)}}" method="post" id="approve_form">
                @csrf
                @method('PATCH')
                <div class="row mt-5">
                    ...
                    <div class="col-md-3 form-group">
                        ...
                        <div class="">
                            <input type="text" data-url="{{route('admin.verified-loan.get_completation_date')}}"
                                id="issue_date" required readonly name="issue_date" placeholder="Enter Issue Date" class="form-control date" >
                        </div>
                    </div>
