@extends('layouts.app', ['title' => _lang('Double Benifit Withdraw'), 'modal' => 'lg'])
{{-- Header Section --}}
@section('page.header')
...
<div class="app-title text-center bg-danger text-white">
    <div class="text-center w-100">
        <h1 data-placement="bottom" title="Double Benifit Withdraw ">{{--<i class="fa fa-users mr-4"></i>--}}
            {{_lang('Double Benifit Withdraw ')}}</h1>
        <p>{{_lang('Here You Can Withdraw Double Benifit')}}</p>
    </div>
    {{--<ul class="app-breadcrumb breadcrumb">
        --}}{{-- {{ Breadcrumbs::render('double-benifit-withdraw') }} --}}{{--
    </ul>--}}
</div>
@stop
...
<div class="tile">
    <div class="tile-body">
        <form action="{{route('admin.double-benifit-withdraw.store')}}" method="post" id="content_form">
            @csrf
            <div class="col-md-12">
                <hr>
                <h4 class="text-center">Withdraw Double Benifit</h4>
                <hr>
            </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <select name="member_id" id="member_id"
                                data-url="{{ route('admin.double-benifit-withdraw.get-double-benifit-account') }}"
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 col-form-label"
                            for="double_benifit_id">{{_lang('Select Double Benifit')}}
                            <span class="text-danger">*</span>
                        </label>
                        <div class="col-sm-8">
                            <select name="double_benifit_id" id="double_benifit_id"
                                data-url="{{ route('admin.double-benifit-withdraw.get-double-benifit-info') }}"
                                class="form-control select" data-placeholder="Please Select Mamber First .." required
                                data-parsley-errors-container="#double_benifit_id_error">

                            </select>
                            <span id="double_benifit_id_error"></span>
                        </div>
                    </div>
                    ...
                    {{--  withdrawable Double Benifir --}}
                    <div class="form-group row">
                        <label class="col-sm-4 col-form-label"
                            for="withdrawable_double_benifit">{{_lang('Withdrawable Double Benifit (Taka)')}}
                            <span class="text-danger">*</span>
                        </label>
                        <div class="col-sm-8">
                            <input type="number" min="0" step="0.01" required name="withdrawable_double_benifit"
                                id="withdrawable_double_benifit" readonly class="form-control">
                        </div>
                    </div>
...
<script src="{{ asset('js/pages/double_benifit_withdraw.js') }}"></script>
