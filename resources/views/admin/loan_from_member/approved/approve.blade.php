...
<div class="tile">
    <div class="tile-body">
        <div class="col-md-12 text-center">
            ...
            <div class="btn-group mt-1" role="group">
                ...
                <a data-placement="bottom" title="Edit Double Benifit"
                    href="{{ route('admin.loan-member-approved-application.edit',$account_information->uuid) }}" id=""
                ...
                <a data-placement="bottom" title="Delete Double Benifit." href="" id="delete_item"
                    ...
                    data-url="{{route('admin.loan-member-approved-application.destroy',$account_information->id) }}"
        ...
        <div class="col-md-12">
            <form action="{{route('admin.loan-member-approved-application.add_approval',$account_information->uuid)}}"
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 form-group">
                        ...
                        <div class="">
                            <input type="text"
                                data-url="{{route('admin.loan-member-approved-application.get_completation_date')}}"
