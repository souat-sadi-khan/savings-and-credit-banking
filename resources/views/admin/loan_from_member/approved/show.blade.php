        ...
        <div class="col-md-12 text-center">
            ...
            <div class="btn-group mt-1" role="group">
                ...
                <a data-placement="bottom" title="Go Back To Previous Page"
                    href="{{ url()->previous() != url()->full() ? url()->previous() : route('admin.loan-member-approved-application.index') }}"
                 ...
                 @can('loan-from-member-approved-application.update')
                    <a data-placement="bottom" title="Edit Double Benifit" href="{{ route('admin.loan-member-approved-application.edit',$account_information->uuid) }}"
                    ...
                    @can('loan-from-member-approved-application.delete')
                    <a data-placement="bottom" title="Delete Double Benifit." href="" id="delete_item" data-id="{{$account_information->id}}"
                        data-url="{{route('admin.loan-member-approved-application.destroy',$account_information->id) }}" class="btn btn-danger btn-sm ml-1"
                        title="{{ _lang('Delete') }}" data-popup="tooltip" data-placement="bottom"><i class="fa fa-trash"></i>Delete</a>
                    @endcan

                    @can('loan-from-member-approved-application.approval')
                    <a data-placement="bottom" title="Approve Account" href="{{ route('admin.loan-member-approved-application.approval',$account_information->uuid) }}"
        ...
        <div class="row">
            ...
            {{-- ====================================================== --}}
             {{-- ::::::::::    Loan from member Info Tab Content    ::::::::: --}}
               ...
               <div class="col-md-12 mt-3">
            <hr>
            <h3 class="text-center mt-3 text-danger">Withdraw Information</h3>
            <hr>
        </div>
             <div class="col-md-6">
                 ...
                 <span>Duration: {{ $account_information->loan_duration }} {{ $account_information->loan_duration_type }}</span><br>
