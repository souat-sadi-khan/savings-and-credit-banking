        ...
        <div class="col-md-12 text-center">
            ...
            <div class="btn-group mt-1" role="group">
                ...
                <a data-placement="bottom" title="Go Back To Previous Page"
                    href="{{ url()->previous() != url()->full() ? url()->previous() : route('admin.loan-member-rejected-application.index') }}"
                 ...
                 @can('loan-from-member-rejected-application.update')
                    <a data-placement="bottom" title="Edit Double Benifit" href="{{ route('admin.loan-member-rejected-application.edit',$account_information->uuid) }}"
                    ...
                    @can('loan-from-member-rejected-application.delete')
                    <a data-placement="bottom" title="Delete Double Benifit." href="" id="delete_item" data-id="{{$account_information->id}}"
                        data-url="{{route('admin.loan-member-rejected-application.destroy',$account_information->id) }}" class="btn btn-danger btn-sm ml-1"
                        title="{{ _lang('Delete') }}" data-popup="tooltip" data-placement="bottom"><i class="fa fa-trash"></i>Delete</a>
                    @endcan

                    @can('loan-from-member-rejected-application.approval')
                    <a data-placement="bottom" title="Approve Account" href="{{ route('admin.loan-member-rejected-application.approval',$account_information->uuid) }}"
