...
<div class="tile">
    <div class="tile-body">
        <form action="{{route('admin.loan-member-rejected-application.update',$model->uuid)}}" method="post"
            id="content_form">
            @method('patch')
            @csrf
                ...
                <div class="col-md-12" align="center">
                    ...
                    <div class="btn-group mt-1 text-center" role="group">
                        ...
                        <a data-placement="bottom" title="Delete Double Benifit." href="" id="delete_item"
                            data-id="{{$model->id}}"
                            data-url="{{route('admin.loan-member-rejected-application.destroy',$model->id) }}"
                        ...
                        <a data-placement="bottom" title="Approve Account"
                            href="{{ route('admin.loan-member-rejected-application.approval',$model->uuid) }}"
