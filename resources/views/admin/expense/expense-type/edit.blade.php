<form action="{{route('admin.expense-type.update', $model->id)}}" method="post" id="content_form">
    @csrf
     @method('PATCH')
     <div class="row">
        ...
        placeholder="Enter Expense Name" required value="{{$model->name}}">
        </div>
        ...
        <div class="col-md-6 form-group">
            ...
            <textarea name="description" id="description"    placeholder="Enter Code" class="form-control" >{{$model->description}}</textarea>
        </div>
