...
<div class="app-title  text-center bg-danger text-white">
    <div class="text-center w-100">
        ...
        Verify Loan Application "> {{--<i class="fa fa-users mr-4"></i>--}}
            {{_lang('Verify Loan Application ')}}</h1>
...
<div class="tile">
    <div class="tile-body">
        <form action="{{route('admin.loan-account.add-verification',$loan_info->id)}}" method="post" id="content_form">
            @csrf
            <div class="row">
                <div class="col-md-12">
                    <hr>
                ...
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <div class="col-md-6"><input type="text" required name="business_duration" placeholder="Business Duration"
                            class="form-control" value="{{$loan_info->business_duration}}"></div>
                        <div class="col-md-6">
                            <select name="duration_indication" id="duration_indication" class="form-control select"
                            data-placeholder="Please Select One .." required>
                            <option value="">Please Select One ..</option>
                            <option value="Year" {{ $loan_info->duration_indication == 'Year' ? "Selected":"" }}>Year
                            </option>
                            <option value="Month" {{ $loan_info->duration_indication == 'Month' ? "Selected":"" }}>Month
                            </option>
                        </select>
                        </div>
                    </div>
                ...
                <div class="col-md-6 form-group">
                    ...
                    <div>
                            <input type="text" required name="business_address" class="form-control" id="business_address" placeholder="Enter Business Address" value="{{$loan_info->business_address}}">
                    </div>
                </div>
...
<div class="col-md-12"><hr></div>
                ...
                <div class="col-md-6">
                    <div class="animated-radio-button">
                        <label>
                            <input type="radio" name="confirmation" class="sohag" value="Confirmed"  {{($loan_info->confirmation == 'Confirmed')?"checked":''}}
                               @if (!$loan_info->confirmation)
                                  checked
                    ...
                    <div class="animated-radio-button">
                        <label>
                            <input type="radio" name="confirmation" class="sohag" value="Refused" {{($loan_info->confirmation == 'Refused')?"checked":''}}><span class="label-text text-danger"  >Refuse Loan</span>
                        </label>
                    </div>
                </div>
