    ...
    <div class="tile-body">
        <div class="col-md-12 text-center">
            ...
            <div class="btn-group mt-1" role="group">
                ...
                <a data-placement="bottom" title="Back" 
                    href="{{ url()->previous() != url()->full() ? url()->previous() : route('admin.loan-account.index') }}"
                    class="btn btn-secondary text-light btn-sm mr-2" title="{{ _lang('Back To Previous Page') }}" data-popup="tooltip"
                    data-placement="bottom">
                    <i class="fa fa-arrow-left"></i>Back
                </a>
                @can('loan-account.update')
                <a data-placement="bottom" title="Edit Loan Account"
                    href="{{ route('admin.loan-account.edit',$account_information->uuid) }}" id=""
                ...
                @can('loan-account.delete')
                <a data-placement="bottom" title="Delete Loan Account." href="" id="delete_item"
                    data-id="{{$account_information->id}}"
                    data-url="{{route('admin.loan-account.destroy',$account_information->id) }}"
                ...
                @can('loan-account.verification')
                <a data-placement="bottom" title="Verify Account"
                    href="{{ route('admin.loan-account.verification',$account_information->uuid) }}"
                    class="btn btn-primary text-light btn-sm ml-1" title="{{ _lang('verify') }}" data-popup="tooltip"
                    data-placement="bottom">
