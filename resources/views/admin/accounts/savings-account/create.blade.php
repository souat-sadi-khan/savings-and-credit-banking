<form action="{{route('admin.savings-account.store')}}" method="post" id="content_form">
    @csrf
    <div class="row">
        <div class="col-md-12">
            <hr>
        ...
        <select name="member_id" id="member_id"   data-url="{{ route('admin.savings-account.member-info') }}" class="form-control select" data-placeholder="Please Select One .." required data-parsley-errors-container="#member_id_error">
                <option value="">Please Select One ..</option>
                @foreach ($model as $member)
            <option value="{{$member->id}}">{{ $member->name_in_bangla.', '.$member->contact_number }}</option>
                @endforeach
            </select>
        ...
        <div class="col-md-6 form-group">
            ...
            <div align="center"><img src="" id="member_image" width="180" class="rounded img-thumbnail"></div>
        </div>
        ...
        <div class="col-md-3 form-group">
            ...
            <div class="input-group">
            <input type="text" class="form-control" id="prefix" name="prefix" value="{{$code_prefix}}">
            </div>
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-6 form-group">
            <label for="nomenee_name">{{_lang('Name')}}
                ...
                <input type="text" required name="nomenee_name" placeholder="Enter Nomenee Name" class="form-control">
        </div>
        ...
        <div class="col-md-6 form-group">
            ...
            <div class="input-group">
                <input type="text"  name="nomenee_fathers_name" placeholder="Enter Father Name"
                    class="form-control">
            </div>
        </div>
        ...
        <div class="col-md-6 form-group">
            ...
            <div class="input-group">
                ...
                <textarea name="nomenee_present_address" id="nomenee_present_address"
                    placeholder="Enter Present Address" style="width:100%"></textarea>
            </div>
        </div>
        ...
        <div class="col-md-6 form-group">
            ...
            <div class="input-group">
                ...
                <textarea name="nomenee_permanent_address" required id="nomenee_permanent_address"
        ...
        {{-- identifier Name --}}
          <div class="col-md-6 form-group">
            ...
            <input type="text"   required name="identifier_name" id="identifier_name" placeholder="Enter Name"
                class="form-control">
        </div>
        ...
        <div class="col-md-6 form-group">
            ...
            <div class="input-group">
                <input type="text"  name="identifier_fathers_name" placeholder="Enter Father Name"
                    class="form-control">
            </div>
        </div>
        ...
        <div class="col-md-6 form-group">
            ...
            <input type="text"   required name="identifier_age" id="identifier_age" placeholder="Enter age"
                class="form-control">
        </div>
