...
<div class="app-title text-center bg-danger text-white">
    <div class="text-center w-100">
        <h1 data-placement="bottom" title="Savings Deposit From Member "><i class="fa fa-users mr-4"></i>
            {{_lang('Savings Deposit From Member ')}}</h1>
        <p>{{_lang('Here You Can Create New Savings Deposit From Member')}}</p>
    </div>
   {{-- <ul class="app-breadcrumb breadcrumb">
        {{ Breadcrumbs::render('savings-deposit') }}
    </ul>--}}
</div>
@stop
...
<div class="tile">
    <div class="tile-body">
        <form action="{{route('admin.savings-deposit.store')}}" method="post" id="content_form">
            @csrf
            <div class="col-md-12">
                <hr>
                <h4 class="text-center">Add New Savings Deposit</h4>
                <hr>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <select name="member_id" id="member_id"
                                data-url="{{ route('admin.savings-deposit.get-savings-account') }}" class="form-control select"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <select name="savings_acc_id" id="savings_acc_id" data-url="{{ route('admin.savings-deposit.get-deposit-info') }}"
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 col-form-label"
                            for="new_deposit">{{_lang('New Deposit Amt')}}
                            <span class="text-danger">*</span>
                        </label>
                        <div class="col-sm-8">
                            <input type="number" min="0" step="1" required name="new_deposit"
                                id="new_deposit" placeholder="Enter New Deposit Amount"  class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="number" min="0"  readonly  name="grand_total_savings" id="grand_total_savings"  placeholder="Total Savings + New Deposit Amt" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" required readonly name="tx_date" id="tx_date" placeholder="Enter Transaction Date"  class="form-control date" value="{{ date("d/m/Y") }}">
                            </div>
                        </div>
