...
<div class="app-title text-center bg-danger text-white">
    <div class="text-center w-100">
        <h1 data-placement="bottom" title="Edit Savings Deposit ">{{--<i class="fa fa-users mr-4"></i>--}}
            {{_lang('Edit Savings Deposit Of ')}}{{$model->member->name_in_bangla}}</h1>
        <p>{{_lang('Here You Can Update Savings Deposit')}}</p>
    </div>
...
<div class="tile">
    <div class="tile-body">
        <form action="{{route('admin.savings-deposit.update', $model->id)}}" method="post" id="content_form">
            @csrf
            @method('PATCH')
            <div class="col-md-12">
                <hr>
                <h4 class="text-center">Update Savings Deposit Of <span
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="number" min="0" step="1" required name="new_deposit" id="new_deposit"
                    ...
                    <div class="form-group row">
                        ...
                        placeholder="Total Savings Till Now" class="form-control" value="{{$payment_status['total_deposit']}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="number" min="0" readonly name="grand_total_savings" id="grand_total_savings"
                                placeholder="Total Savings + New Deposit Amt" class="form-control"  value="{{$payment_status['total_deposit'] }}">
                        </div>
                    </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="hidden" readonly name="savings_in_hand" id="savings_in_hand" placeholder=""
                                    class="form-control" value="{{$payment_status['total_deposit'] - $model->grand_total_amt}}">
                            </div>
                        </div>
                            ...
                            <div class="tab-pane fade" id="withdraw" role="tabpanel" aria-labelledby="withdraw-tab">
                                ...
                                <table id="withdraw_data_table" class="table table-striped table-bordered"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$i}}</td>
                                            <td>{{carbonDate($withdraw->created_at)}}</td>
