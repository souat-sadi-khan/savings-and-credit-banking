@extends('layouts.app', ['title' => _lang('Head Wise Report'), 'modal' => 'lg'])
...
<div class="app-title">
    <div>
        <h1 data-placement="bottom" title="Head Wise Report."><i class="fa fa-universal-access mr-4"></i>
            {{_lang('Head Wise Report')}}</h1>
        <p>{{_lang('Head Wise Report. Here you can See Head Wise Report')}}</p>
    </div>
                ...
                <div id="print_table" style="color:black">
                    ...
                    <div class="text-center col-md-12">
                        <h4 style="margin:0px ; margin-top: 7px; border:solid 1px #000; border-radius:50px; display:inline-block; padding:10px;"
                            class="{{ $report_type =="HEAD WISE INCOME REPORT"?"bg-success ":"bg-danger" }} text-light">
                            <b>{{$report_type}}</b></h4>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 text-left">
                            ...
                            <p style="margin:0px ;">
                                {{ $report_type =="HEAD WISE INCOME REPORT"?"Income ":"Expense" }} Head : <span
                                    class="ml-1">{{$head_name}}</span>
