<form action="{{route('admin.voucher-report.store')}}" method="post" id="report_form">
    @csrf
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-6 form-group" style="display:none">
            ...
            <input type="hidden" required readonly name="report_type" placeholder="Enter End Date " class="form-control"
                value="{{$report_type}}">
