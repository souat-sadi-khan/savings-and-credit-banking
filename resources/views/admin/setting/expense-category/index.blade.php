...
@section('page.header')
    <div class="app-title text-center bg-danger text-white">
        <div class="text-center w-100">
            ...
            <p>{{_lang('Create Expense Category. Here you can Add, Edit & Delete The Expense Category')}}</p>
        </div>
        {{--<ul class="app-breadcrumb breadcrumb">
            {{ Breadcrumbs::render('expense-category') }}
        </ul>--}}
    </div>
@stop
            ...
            <div class="tile">
                <h3 class="tile-title">
                    @can('expense_category.create')
                        <button data-placement="bottom" title="Create New Expense Category" type="button" class="btn btn-info" id="content_managment" data-url ="{{ route('admin.expense-category.create') }}"><i class="fa fa-plus-square mr-2" aria-hidden="true"></i></i>{{_lang('create')}}</button>
                    @endcan
                </h3>
                <div class="tile-body">
