@extends('layouts.app', ['title' => _lang('Member Share Withdraw'), 'modal' => 'lg'])
{{-- Header Section --}}
@section('page.header')
...
<div class="app-title">
    <div>
        <h1 data-placement="bottom" title="Member Share Withdraw "><i class="fa fa-users mr-4"></i>
            {{_lang('Member Share Withdraw ')}}</h1>
        <p>{{_lang('Here You Can Withdraw Member Share Several Times.')}}</p>
    </div>
...
<div class="tile">
    <div class="tile-body">
        <form action="{{route('admin.share-withdraw.store')}}" method="post" id="content_form">
            @csrf
            <div class="col-md-12">
                <hr>
                <h4 class="text-center">Withdraw Member Share</h4>
                <hr>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <h5 class="text-center text-info">Share Withdraw Information</h5>
                        <hr>
                    </div>
                    {{-- select member --}}
                    ...
                    {{--  grand_total --}}
                    <div class="form-group row">
                        <label class="col-sm-4 col-form-label" for="grand_total">{{_lang('Grand Total Savings')}}
                            <span class="text-danger">*</span>
                        </label>
                        <div class="col-sm-8">
...
<script src="{{ asset('js/pages/share_withdraw.js') }}"></script>
