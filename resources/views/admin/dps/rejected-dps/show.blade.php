{{-- {{ dd(url()->full()) }} --}}
@extends('layouts.app', ['title' => _lang('Rejected DPS Application Information'), 'modal' => 'lg'])
...
<div class="app-title text-center bg-danger text-white">
    <div class="text-center w-100">
        <h1 data-placement="bottom"
            title="Rejected DPS Application Information Of  {{$account_information->member->name_in_bangla}}">{{--<i
                class="fa fa-users mr-4"></i>--}}
            {{_lang('Rejected DPS Application Information Of ')}}{{$account_information->member->name_in_bangla}}</h1>
        <p>{{_lang('Here you can Rejected DPS application')}}</p>
    </div>
            ...
            <div class="btn-group mt-1" role="group">
                ...
                @endcan
                 @can('dps-pending-application.approval')
                    <a data-placement="bottom" title="Update DPS Approval Information" href="{{ route('admin.dps-pending-application.approval',$account_information->uuid) }}"
                        class="btn btn-primary text-light btn-sm ml-1" title="{{ _lang('Approve') }}"  data-popup="tooltip" data-placement="bottom">
                        <i class="fa fa-check-circle"></i>Update Approval
                    </a>
                @endcan
