...
{{-- {{ dd(url()->full()) }} --}}
@extends('layouts.app', ['title' => _lang('Approve DPS Application'), 'modal' => 'lg'])

{{-- Header Section --}}
@section('page.header')
<div class="app-title text-center bg-danger text-white">
    <div class="text-center w-100">
        <h1 data-placement="bottom" title="Approve DPS Application Of  {{$account_information->member->name_in_bangla}}">{{--<i
                class="fa fa-users mr-4"></i>--}}
            {{_lang('Approve DPS Application Of ')}}{{$account_information->member->name_in_bangla}}</h1>
        <p>{{_lang('Here you can see approved DPS application')}}</p>
    </div>
...
<div class="tile">
    <div class="tile-body">
        ...
        <div class="col-md-12">
            <form action="{{route('admin.dps-pending-application.add_approval',$account_information->uuid)}}" method="post" id="approve_form">
                @csrf
                @method('PATCH')
                <div class="row mt-5">
