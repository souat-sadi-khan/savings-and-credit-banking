<form action="{{route('admin.dps-type.store')}}" method="post" id="content_form">
    @csrf
    <div class="row">
        ...
        <div class="col-md-6 form-group">
            <div class="row">
                ...
                <div class="col-md-6">
                    <input type="text" required name="duration" placeholder="DPS Duration" class="form-control">
                </div>
                <div class="col-md-6">
                    <select name="duration_type" id="duration_type" data-placeholder="Please Select One.."
                        class="form-control select" data-parsley-errors-container="#dps_duration_error" required>
                        <option value="">Please Select One .. </option>

                        <option value="Month">Month</option>
                        <option value="Year">Year</option>
                    </select>
                    <span id="dps_duration_error"></span>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <select name="installment_period_type" id="installment_period_type"
                        ...
                        data-parsley-errors-container="#installment_period_type_error" required>
                        <option value="">Please Select One .. </option>
