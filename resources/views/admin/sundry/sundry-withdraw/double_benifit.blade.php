...
<div class="app-title">
    <div>
        <h1 data-placement="bottom" title="Sundry withdraw "><i class="fa fa-users mr-4"></i>
            {{_lang('Sundry withdraw Of Double Benifit')}}</h1>
        <p>{{_lang('Here You Can Sundry amount of double Benefit')}}</p>
    </div>
...
<div class="tile">
  ...
  <tbody class="bg-info">
      ...
      @endfor
         <tr>
        <td colspan="3" class="text-right text-light"><h4 >Total Withdrawable Amount Of Double Benifit</h4></td>
        <td class="text-light"><h4>{{ $sundry_info['total'] }}</h4></td>
    </tr>
    @else 
    <tr>
        <td colspan="4" class="text-center text-light"><h4 >No Double Benefit Withdrawable Amount Found</h4></td>
      </tr>
      @endif
