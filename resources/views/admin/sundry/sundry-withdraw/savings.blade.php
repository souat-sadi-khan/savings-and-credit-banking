...
<div class="app-title">
    <div>
        <h1 data-placement="bottom" title="Sundry Withdraw "><i class="fa fa-users mr-4"></i>
            {{_lang('Sundry Withdraw Of Savings')}}</h1>
        <p>{{_lang('Here You Can Withdraw Sundry Amount Of Savings.')}}</p>
    </div>
...
<div class="tile">
  ...
  <tbody class="bg-info">
      ...
      <tr>
   <td colspan="3" class="text-right text-light"><h4 >Total Withdrawable Amount Of Savings</h4></td>
   <td class="text-light"><h4>{{ $sundry_info['total'] }}</h4></td>
</tr>
      @else
    <tr>
        <td colspan="4" class="text-center text-light"><h4 >No Withdrawable Amount Of Savings Fount</h4></td>
      </tr>
      @endif
