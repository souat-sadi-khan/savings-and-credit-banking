  ...
  <tbody class="bg-info">
      ...
      @for ($i=0; $i < $no_of_accounts; $i++)
          @php
              ...
              $account_no = get_id_account_no('share',$sundry_info['info'][$i]->prefix,$sundry_info['info'][$i]->code);
      ...
      <tr>
   <td colspan="3" class="text-right text-light"><h4 >Total Sundry Amount Of DPS</h4></td>
   <td class="text-light"><h4>{{ $sundry_info['total'] }}</h4></td>
</tr>
      @else
    <tr>
        <td colspan="4" class="text-center text-light"><h4 >No DPS Account Found</h4></td>
      </tr>
      @endif
