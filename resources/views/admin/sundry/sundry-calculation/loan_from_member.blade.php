...
<div class="tile">
    <div class="tile-body">
        <div class="col-md-12" style="margin-top:-10px">
            <hr>
            <h4 class="text-center text-info">Sundry Of Loan From Member Calculation For: <span class="text-danger">{{$sundry_month}}</span>
            </h4>
            <hr>
        </div>
        <div class="col-md-12">
  ...
  <tbody class="bg-info">
      ...
      @endfor
         <tr>
        <td colspan="3" class="text-right text-light"><h4 >Total Sundry Amount Of Loan From Member</h4></td>
        <td class="text-light"><h4>{{ $sundry_info['total'] }}</h4></td>
    </tr>
    @else 
    <tr>
        <td colspan="4" class="text-center text-light"><h4 >No Loan From Member Account Found</h4></td>
      </tr>
      @endif
