...
<div class="tile">
    <div class="tile-body">
        <div class="col-md-12" style="margin-top:-10px">
            <hr>
            <h4 class="text-center text-info">Sundry Of Savings Calculation For: <span class="text-danger">{{$sundry_month}}</span>
            </h4>
            <hr>
        </div>
        <div class="col-md-12">
  ...
  <tbody class="bg-info">
      ...
      @for ($i=0; $i < $no_of_accounts; $i++)
          @php
              ...
              $account_no = get_id_account_no('savings',$sundry_info['info'][$i]->prefix,$sundry_info['info'][$i]->code);
      ...
      <tr>
   <td colspan="3" class="text-right text-light"><h4 >Total Sundry Amount Of Savings</h4></td>
   <td class="text-light"><h4>{{ $sundry_info['total'] }}</h4></td>
</tr>
      @else
    <tr>
        <td colspan="4" class="text-center text-light"><h4 >No Savings Account Fount</h4></td>
      </tr>
      @endif
