    ...
    <div class="card-body">
        <form action="{{route('admin.employee-list.store')}}" method="post" id="content_form">
            ...
            <div class="row">
                ...
                {{-- Contact Number --}}
                <div class="col-md-6 form-group">
                    <label for="name">{{_lang('Contact Number')}}
                    </label>
                    <input type="text" name="contact_number" id="contact_number" class="form-control"
                    placeholder="Enter Contact Number" maxlength="14">
                </div>   
                ...
                <div class="col-md-6 form-group">
                    ...
                    <select data-parsley-errors-container="#parsley_error_select_gender_for_creating_new_employee" data-placeholder="Please Select One" name="gender" id="gender" class="form-control select">
                        <option value="">Please Select One..</option>
