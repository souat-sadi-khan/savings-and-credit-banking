...
<!-- Basic initialization -->
    ...
    <div class="card-header row">
        ...
        <div class="form-group col-md-6" align="right">
            <h3 class="tile-title">
                    ...
                    <a data-placement="bottom" title="Employee Attendance List" type="button" class="btn btn-info" href="{{ route('admin.employee-attendance.index') }}"><i class="fa fa-bars mr-2" aria-hidden="true"></i></i>{{_lang('Attendance List')}}</a>
                    @endcan
                </h3>
        </div>
    </div>
    ...
    <div class="card-body">
        <form action="{{route('admin.employee-attendance.store')}}" method="post" id="content_form">
            @csrf
            <div class="row">
...
{{-- Filter Employee --}}
            ...
            <div class="col-md-4 form-group">
                ...
                <select name="department[]" class="form-control select" multiple id="department" data-placeholder="Select Department" data-url="{{ route('admin.employee-attendance.department') }}">
            ...
            <div class="col-md-4 form-group">
                ...
                <select name="designation[]" class="form-control select" multiple id="designation" data-placeholder="Select Designation" data-url="{{ route('admin.employee-attendance.designation') }}">
            ...
            {{-- Date of Attendance --}}
            <div class="col-md-4 form-group">
                    <label for="date">{{_lang('Date of Attendance')}} <span class="text-danger">*</span>
                    </label>
                <input type="text" value="{{now()}}" autocomplete="off" data-url="{{ route('admin.employee-attendance.date') }}" name="date" id="date" class="form-control date" placeholder="Date of Attendance" required>
            </div>
                <div class="col-12">
