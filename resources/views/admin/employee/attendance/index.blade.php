    ...
    <div class="card-header row">
        ...
        <div class="form-group col-md-6" align="right">
            <h3 class="tile-title">
                    ...
                    <a data-placement="bottom" title="Create New Employee Attendance" type="button" class="btn btn-info" href="{{ route('admin.employee-attendance.create') }}"><i class="fa fa-plus-square mr-2" aria-hidden="true"></i></i>{{_lang('create')}}</a>
                    @endcan
                </h3>
        </div>
    </div>
...
@push('scripts')
    ...
    <script>
        ...
        var month = $('#month').val();
        $.ajax({
            url: '{{route("admin.employee-attendance.fetch")}}',
            type: 'POST',
