<table class="table table-sm table-bordered attendance-table">
    ...
    <tbody>
        ...
        <tr>
            ...
            $date = $months.'-'.$item;
            $query =
            App\models\employee\EmployeeAttendance::where('employee_id',$employee->id)->whereDate('date_of_attendance',$date)->first();
            ...
            $alias = App\models\employee\EmployeeAttendanceType::where('type','Holiday')->first();
