        ...
        <div class="col-md-12">
            <div class="tile">
                <h3 class="tile-title">
                    ...
                    <a data-placement="bottom" title="Create New Employee Payroll Template" type="button" class="btn btn-info" id="" href="{{ route('admin.employee-payroll-template.create') }}"><i class="fa fa-plus-square mr-2" aria-hidden="true"></i></i>{{_lang('create')}}</a>
                    @endcan
                </h3>
                <div class="tile-body">
                    <table class="table table-hover table-bordered content_managment_table" data-url="{{ route('admin.employee-payroll-template.datatable') }}">
                        <thead>
                            <tr>
                                <th>{{_lang('id')}}</th>
                                <th>{{_lang('Name')}}</th>
