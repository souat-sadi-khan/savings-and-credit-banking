<form action="{{route('admin.income-list.submit-pay', $model->id)}}" method="post" id="content_form">
    @csrf
     @method('PATCH')
     <div class="row">
        ...
        <div class="col-md-6 form-group">
            <label for="current_due">{{_lang('income Amount')}}
               
            </label>
            <input type="number" min="0" readonly  name="current_due" id="current_due" placeholder="income Amount"
