<form action="{{route('admin.income-list.store')}}" method="post" id="content_form">
    @csrf
    <div class="row">
        ...
        <div class="col-md-6 form-group">
            ...
            <input type="text" required readonly name="income_date" id="income_date" placeholder="Enter income Date"
        ...
        <div class="col-md-12 form-group">
            <label for="income_note">
                ...
                <textarea  name="income_note" id="income_note"  class="form-control"></textarea>
        </div>
