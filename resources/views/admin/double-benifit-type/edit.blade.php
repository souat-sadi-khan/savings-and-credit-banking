<form action="{{route('admin.double-benifit-type.update', $model->id)}}" method="post" id="content_form">
    @csrf
    @method('PATCH')
    <div class="row">
        ...
        <div class="col-md-12 form-group">
            <div class="row">
                ...
                <div class="col-md-6">
                    <input type="text" required name="duration" placeholder="Double Benifit Duration"
