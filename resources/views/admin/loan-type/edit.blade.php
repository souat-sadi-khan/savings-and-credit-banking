<form action="{{route('admin.loan-type.update', $model->id)}}" method="post" id="content_form">
    @csrf
     @method('PATCH')
     <div class="row">
        ...
        <div class="col-md-6 form-group">
            <div class="row">
                ...
                <div class="col-md-6">
                <input  type="text" required name="duration" placeholder="Loan Duration" class="form-control" value="{{$model->duration}}">
            </div>
            <div class="col-md-6">
        ...
        <div class="col-md-6 form-group">
            ...
            <div class="col-md-6">
                <select name="installment_period_type" id="installment_period_type" data-placeholder="Please Select One.." class="form-control select">
                    <option value="">Please Select One .. </option>
                    <option value="Day" {{ $model->installment_period_type == 'Day'?"selected":"" }}>Day</option>
