...
class CreateLoanConfirmationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('loan_confirmations', function (Blueprint $table) {
            ...
            $table->string('shop_previous_position_owner')->nullable();
            $table->string('position_buy_date')->nullable();
            $table->string('rent_start_date')->nullable();
            $table->string('shop_rent_per_month')->nullable();
            $table->string('shop_owner_name')->nullable();
            $table->string('shop_booked_from')->nullable();
    ...
    {
        Schema::dropIfExists('loan_confirmations');
    }
}
