...
$(document).ready(function () {
    ...
    $(document).on('change', '#member_id', function () {
        ...
        $("#withdrawable_double_benifit").val('');
        ...
        $.ajax({
            ...
            .done(function (data) {
                $("#double_benifit_id").html(data.options);
            })
    });

    // :::::::::     Get Loan Information while changing loan id  :::::::::::
    $(document).on('change', '#double_benifit_id', function () {
        $("#withdrawable_double_benifit").val('');
        $("#withdrawable_interest").val('');
        $("#withdrawable").val('');
        $("#now_withdrable_total_calc").val('');
        ...
        var double_benifit_id = $(this).val();
        var url = $(this).data('url');
        $.ajax({
                url: url,
                type: 'post',
                data: {
                    double_benifit_id: double_benifit_id
                },
                dataType: 'json'
            })
            .done(function (data) {
                ...
                $("#now_withdrable_total_calc").val(data.due_and_payment_status.now_withdrable_double_benifit);

                $("#withdrawable_double_benifit").val(data.due_and_payment_status.now_withdrable_double_benifit);
                ...
                if (data.due_and_payment_status.expiry == 'No') {
    ...
    // change withdrawable Interest amount
    $(document).on('change keyup blur', '#withdrawable_interest', function () {
        var interest = $(this).val();
        var double_benifit = $('#now_withdrable_total_calc').val();
        var double_benifit_id = $('#double_benifit_id').val();

        if (isNaN(double_benifit) || double_benifit == '' || double_benifit == null) {
            double_benifit = 0;
        }
        ...
        if (double_benifit_id == null) {
            swal({
                title: "Please Select A Double Benifit Account",
                type: "warning",
            ...
            var total = parseFloat(interest) + parseFloat(double_benifit);
