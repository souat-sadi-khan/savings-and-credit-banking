...
class DpsPendingApplicationController extends Controller
{
    /**
    ...
    {
        return view('admin.dps.dps-pending-application.index');
    }
    ...
    {
        if ($request->ajax()) {
            $model = DpsAccount::where('approval', 'Not Approved')->get();
            return Datatables::of($model)
                ...
                ->addColumn('action', function ($model) {
                    return view('admin.dps.dps-pending-application.action', compact('model'));
                })
    ...
    public function show($uuid)
    {
        ...
        return view('admin.dps.dps-pending-application.show', compact('account_information'));
    }
    ...
    public function edit($uuid)
    {
        ...
        return view('admin.dps.dps-pending-application.edit', compact('model', "members", 'dps_types'));
    }
    ...
    public function approve($uuid)
    {
        // dd($uuid);
        $account_information = DpsAccount::where('uuid', $uuid)->firstOrFail();
        return view('admin.dps.dps-pending-application.approve', compact('account_information'));
    }
