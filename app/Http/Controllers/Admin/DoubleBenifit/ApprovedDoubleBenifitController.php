...
class ApprovedDoubleBenifitController extends Controller
{
    /**
    ...
    {
        return view('admin.double_benifit.approved-double-benifit.index');
    }
    ...
    {
        if ($request->ajax()) {
            $model = DoubleBenifitAccount::where('approval', 'Approved')->get();
            return Datatables::of($model)
                ...
                ->addColumn('action', function ($model) {
                    return view('admin.double_benifit.approved-double-benifit.action', compact('model'));
                })
    ...
    public function show($uuid)
    {
        ...
        $transaction_info = Transaction::where('double_benifit_account_id', $account_information->id)->where('tx_type', 'double benifit repay')->get();

        $due_and_payment_status = current_payment_status('double benifit', $account_information->id);

        return view('admin.double_benifit.approved-double-benifit.show', compact('account_information', 'transaction_info', 'due_and_payment_status'));
    }
    ...
    public function edit($uuid)
    {
        ...
        return view('admin.double_benifit.approved-double-benifit.edit', compact('model', "members", 'double_benifit_types'));
    }
    ...
    public function update(Request $request, $uuid)
    {
        ...
        activity()->log('Updated Double Benifit Account ');
    ...
    // the following function is for Double Benifit Application Approval
    public function approve($uuid)
    {
        // dd($uuid);
        $account_information = DoubleBenifitAccount::where('uuid', $uuid)->firstOrFail();
        return view('admin.double_benifit.approved-double-benifit.approve', compact('account_information'));
    }

    // the following function is for adding Double Benifit Application Approval
    public function add_approve(Request $request, $uuid)
    {
        ...
        // now updating  transaction table 
        ...
        if ($transaction) {
            ...
            if ($request->approval == 'Approved') {
                ...
                $transaction->tx_date = $model->approval_date;
