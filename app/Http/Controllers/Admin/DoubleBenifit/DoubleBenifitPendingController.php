...
class DoubleBenifitPendingController extends Controller
{
    /**
    ...
    {
        return view('admin.double_benifit.double-benifit-pending-application.index');
    }
    ...
    {
        if ($request->ajax()) {
            $model = DoubleBenifitAccount::where('approval', 'Not Approved')->get();
            return Datatables::of($model)
                ...
                ->addColumn('action', function ($model) {
                    return view('admin.double_benifit.double-benifit-pending-application.action', compact('model'));
                })
    ...
    public function show($uuid)
    {
        ...
        return view('admin.double_benifit.double-benifit-pending-application.show', compact('account_information'));
    }
    ...
    public function edit($uuid)
    {
        ...
        return view('admin.double_benifit.double-benifit-pending-application.edit', compact('model', "members", 'double_benifit_types'));
    }
    ...
    public function approve($uuid)
    {
        // dd($uuid);
        $account_information = DoubleBenifitAccount::where('uuid', $uuid)->firstOrFail();
        return view('admin.double_benifit.double-benifit-pending-application.approve', compact('account_information'));
    }
    ...
    public function add_approve(Request $request, $uuid)
    {
        ...
        if ($request->approval == 'Approved') {
            ...
            $transaction->grand_total_amt = $model->double_benifit_amt;
