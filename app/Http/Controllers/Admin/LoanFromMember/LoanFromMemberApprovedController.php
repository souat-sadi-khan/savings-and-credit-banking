...
class LoanFromMemberApprovedController extends Controller
{
    /**
    ...
    {
        return view('admin.loan_from_member.approved.index');
    }
    //  ajax data table for showing data  in tabel 
    public function datatable(Request $request)
    {
        if ($request->ajax()) {
            $model = FdrAccount::where('approval', 'Approved')->with('fdrMember')->get();
            // dd($model);
            return Datatables::of($model)
                ...
                ->addColumn('action', function ($model) {
                    return view('admin.loan_from_member.approved.action', compact('model'));
                })
    ...
    public function show($uuid)
    {
        ...
        $transaction_info = Transaction::where('fdr_account_id', $account_information->id)->where('tx_type', 'fdr repay')->get();

        $due_and_payment_status = current_payment_status('fdr', $account_information->id);

        return view('admin.loan_from_member.approved.show', compact('account_information', 'transaction_info', 'due_and_payment_status'));
    }
    ...
    public function edit($uuid)
    {
        ...
        return view('admin.loan_from_member.approved.edit', compact('model', "members", 'fdr_types'));
    }
    ...
    public function approve($uuid)
    {
        // dd($uuid);
        $account_information = FdrAccount::where('uuid', $uuid)->with('fdrMember')->firstOrFail();
        return view('admin.loan_from_member.approved.approve', compact('account_information'));
    }
    ...
    // provide issue date and get corresponding completation date
