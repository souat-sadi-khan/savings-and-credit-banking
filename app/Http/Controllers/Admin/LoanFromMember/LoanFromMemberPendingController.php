...
class LoanFromMemberPendingController extends Controller
{
    /**
    ...
    {
        return view('admin.loan_from_member.pending.index');
    }
    ...
    {
        if ($request->ajax()) {
            $model = FdrAccount::where('approval', 'Not Approved')->with('fdrMember')->get();
            // dd($model);
            return Datatables::of($model)
                ...
                ->addColumn('action', function ($model) {
                    return view('admin.loan_from_member.pending.action', compact('model'));
                })
    ...
    public function show($uuid)
    {
        ...
        return view('admin.loan_from_member.pending.show', compact('account_information'));
    }
    ...
    public function edit($uuid)
    {
        ...
        return view('admin.loan_from_member.pending.edit', compact('model', "members", 'fdr_types'));
    }
    ...
    public function approve($uuid)
    {
        // dd($uuid);
        $account_information = FdrAccount::where('uuid', $uuid)->with('fdrMember')->firstOrFail();
        return view('admin.loan_from_member.pending.approve', compact('account_information'));
    }
    ...
    public function add_approve(Request $request, $uuid)
    {
        ...
        if ($request->approval == 'Approved') {
            ...
            $transaction->grand_total_amt = $model->loan_amt * 1 + $model->total_interest_amt * 1;
