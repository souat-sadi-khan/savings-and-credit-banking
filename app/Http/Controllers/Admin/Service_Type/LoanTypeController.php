...
class LoanTypeController extends Controller
{
    ...
    {
        $model = LoanType::all();
        return view('admin.loan-type.index', compact('model'));
    }
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($model)
                ...
                ->addColumn('action', function ($model) {
                    return view('admin.loan-type.action', compact('model'));
    ...
    {
        return view('admin.loan-type.create');
    }
    ...
    {
        $model = LoanType::findOrFail($id);

        return view('admin.loan-type.edit', compact('model'));
    }
