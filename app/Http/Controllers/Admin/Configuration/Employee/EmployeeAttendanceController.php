...
class EmployeeAttendanceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return response()->json(['success' => true, 'status' => 'success', 'message' => _lang('Data Created'), 'goto' => route('admin.employee-attendance.index')]);
    }
    ...
    public function date(Request $request)
    {
        ...
        $employee = Employee::whereIn('id', $employees_id)->get();
        $types = EmployeeAttendanceType::where('is_active', '1')->where('type', '!=', 'production_based_deduction')->where('type', '!=', 'production_based_earning')->get();
        return view('admin.employee.attendance.date', compact('employee', 'types', 'date1'));
    }
