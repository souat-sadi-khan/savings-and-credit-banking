...
class RejectedLoanController extends Controller
{
    /**
    ...
    {
        return view('admin.accounts.rejected-loan.index');
    }
    ...
    {
        if ($request->ajax()) {
            $model = LoanAccount::where('confirmation', 'Refused')->get();
            return Datatables::of($model)
                ...
                ->addColumn('action', function ($model) {
                    return view('admin.accounts.rejected-loan.action', compact('model'));
                })
    ...
    public function show($uuid)
    {
        ...
        return view('admin.accounts.rejected-loan.show', compact('account_information', 'member'));
    }
